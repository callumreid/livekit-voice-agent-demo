...
# Track which provider served the last STT result for provider sub-spans.
_active_stt_provider: ContextVar[str] = ContextVar("active_stt_provider", default="deepgram")


def set_active_stt_provider(name: str) -> None:
    """Set the STT provider that served the last result (for provider sub-spans)."""
    _active_stt_provider.set(name)
